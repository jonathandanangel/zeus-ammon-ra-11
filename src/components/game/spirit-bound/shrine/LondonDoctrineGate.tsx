...
export function LondonDoctrineGate({ paperOrder, onSolved, onAbort }: Props) {
  ...
  if (phase === "cleared") {
    return (
      <section className="flex min-h-[420px] flex-col items-center justify-center gap-4 rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-6 text-center font-pixel text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
  ...
  if (phase === "verbal") {
    return (
      <section className="relative overflow-hidden rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-3 font-pixel text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)] sm:p-4">
        <FeedbackLayer
