...
export function Battle({ enemy, level, hp, maxHp, items: startItems, onEnd }: Props) {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[640px] select-none rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-3 font-pixel text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
