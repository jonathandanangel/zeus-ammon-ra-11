...
export function EggHatchIntro({ onDone }: Props) {
  ...
  return (
    <motion.button
      ...
      className="flex min-h-[420px] w-full flex-col items-center justify-center gap-3 rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-4 text-center shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]"
    >
      <canvas
        ref={canvasRef}
        width={W}
