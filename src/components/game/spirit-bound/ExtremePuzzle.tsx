...
const goldPanel =
  "relative z-[1] mx-auto flex w-full max-w-2xl flex-col gap-4 rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-5 text-center text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)] sm:p-8";
...
export function ExtremePuzzle({ onExit }: Props) {
  ...
  return shell(
    <section className="relative z-[1] mx-auto w-full max-w-3xl overflow-hidden rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
