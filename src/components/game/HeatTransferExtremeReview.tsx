...
export function HeatTransferExtremeReview({
  ...
  const btn =
    "rounded-sm border border-[#ff2a2a]/70 bg-deepblue/50 backdrop-blur-sm px-4 py-2 font-display text-xs uppercase tracking-[0.2em] text-[#ff2a2a] hover:bg-[#ff2a2a]/20";
