...
export function ExtremeV2Review({
  ...
  const btn =
    "rounded-sm border border-[#e879f9]/60 bg-deepblue/50 backdrop-blur-md px-4 py-2 font-display text-xs uppercase tracking-[0.2em] text-[#e879f9] hover:bg-[#e879f9]/20";
