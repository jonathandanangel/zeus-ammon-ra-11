    ...
    <div className="panel mx-auto w-full max-w-3xl space-y-4 p-5">
      ...
      {phase === "brief" ? (
        <div className="space-y-4 py-8 text-center">
          ...
          <button
            type="button"
            className="rounded-sm border border-cyan/60 bg-deepblue/50 backdrop-blur-md px-6 py-3 font-display text-sm uppercase tracking-[0.2em] text-cyan hover:bg-cyan/20"
            onClick={beginStage}
          >
            Begin trial
          </button>
