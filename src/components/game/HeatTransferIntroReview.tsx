...
export function HeatTransferIntroReview({
  ...
  const btn =
    "rounded-sm border border-[#ff8c1a]/70 bg-deepblue/50 backdrop-blur-sm px-4 py-2 font-display text-xs uppercase tracking-[0.2em] text-[#ff8c1a] hover:bg-[#ff8c1a]/20";
