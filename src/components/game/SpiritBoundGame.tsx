    ...
    >
      ...
      >
        ...
        {(mode === "overworld" || mode === "dialogue") && (
          <section className="relative overflow-hidden rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
            {mapId === "greenvale" ? (
              <Overworld
                spawn={spawn}
        ...
        {mode === "gameover" && (
          <section className="flex min-h-[420px] flex-col items-center justify-center gap-6 rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-8 text-center text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
        ...
        {mode === "ending" && (
          <section className="flex min-h-[420px] flex-col items-center justify-center gap-5 rounded-sm border border-[#39ff14]/75 bg-deepblue/50 backdrop-blur-md p-8 text-center text-[#f8f0c8] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_80px_rgba(0,0,0,0.45)]">
